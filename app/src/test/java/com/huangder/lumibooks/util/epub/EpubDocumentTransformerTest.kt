...
class EpubDocumentTransformerTest {
    ...
    fun removesActiveContentButPreservesPublisherLayout() {
        ...
        assertFalse(output.contains("if (imageTap && !centerImageTap) {"))
        ...
        assertTrue(output.contains("(!anchor || coverImageTap)"))
        assertTrue(output.contains("previewImageAt(event.target, touch.clientX, touch.clientY)"))
