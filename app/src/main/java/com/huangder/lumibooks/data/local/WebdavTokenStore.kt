...
/** Stores the WebDAV password encrypted by a non-exportable Android Keystore key. */
@Singleton
class WebdavTokenStore @Inject constructor(
    ...
    fun save(token: String) {
        ...
        require(normalized.isNotEmpty()) { "WebDAV password must not be empty" }
    ...
    private companion object {
        const val PREFERENCES_NAME = "webdav_secure"
        const val KEY_ALIAS = "lumibooks_webdav_token"
